export default {
  ...
  questions: [
    ...
    {
      id: 'gtl-dholuo',
      video: 'https://www.youtube.com/watch?v=pjtSNq2yXVE',
      answer: 'Dholuo',
      countries: ['Kenya', 'Tanzania'],
      explanation: 'Dholuo (Luo) is a Western Nilotic language spoken around Lake Victoria, especially in western Kenya and northern Tanzania. It is central to Luo cultural identity and has a strong oral storytelling tradition.',
    },
    {
      id: 'gtl-pular',
      video: 'https://www.youtube.com/watch?v=_z62HlBXJJ8',
      answer: 'Pular',
      countries: ['Guinea', 'Senegal', 'Guinea-Bissau', 'Sierra Leone', 'Mali'],
      explanation: 'Pular is a Fula language widely spoken in Guinea (especially Fouta Djallon) and across neighboring West African countries. It belongs to the Atlantic branch of Niger-Congo and forms part of the broader Fulfulde/Pulaar continuum.',
    },
    {
      id: 'gtl-northern-sotho',
      video: 'https://www.youtube.com/watch?v=aQNZL4zrDaY',
      answer: 'Northern Sotho (Sepedi)',
      countries: ['South Africa'],
      explanation: 'Northern Sotho (often associated with Sepedi) is one of South Africa\'s official languages, spoken mainly in Limpopo, Gauteng, and Mpumalanga. It is part of the Sotho-Tswana language group.',
    },
    {
      id: 'gtl-lozi',
    ...
    {
      id: 'gtl-kimbundu',
      video: 'https://www.youtube.com/watch?v=a7rbopMACEo',
      answer: 'Kimbundu',
      countries: ['Angola'],
      explanation: 'Kimbundu is a major Bantu language of Angola, especially around Luanda, Bengo, and Malanje. It has significantly influenced Angolan Portuguese vocabulary and culture.',
    },
    {
      id: 'gtl-tigrinya',
      video: 'https://www.youtube.com/watch?v=Z7y-pVnVNAo',
      answer: 'Tigrinya',
      countries: ['Eritrea', 'Ethiopia'],
      explanation: 'Tigrinya is an Ethio-Semitic language spoken mainly in Eritrea and northern Ethiopia (Tigray). It is written in the Ge\'ez script and is one of the major languages of the Horn of Africa.',
    },
  ],
}
