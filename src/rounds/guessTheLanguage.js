const DEV_VIDEO_PATH_PREFIX = 'guess_the_language/'

function videoRef(localFilename, bucketFilename = localFilename) {
  if (!import.meta.env.VITE_DEV_BUCKET_URL) return localFilename
  return `${DEV_VIDEO_PATH_PREFIX}${bucketFilename}`
}
...
export default {
  ...
  questions: [
    {
      id: 'gtl-yoruba',
      video: videoRef('Yoruba.mov', 'Yoruba.mp4'),
      answer: 'Yoruba',
    ...
    {
      id: 'gtl-swahili',
      video: videoRef('Swahili.mov', 'Swahili.mp4'),
      answer: 'Swahili',
    ...
    {
      id: 'gtl-zulu',
      video: videoRef('Zulu.mov', 'Zulu.mp4'),
      answer: 'Zulu',
    ...
    {
      id: 'gtl-kinyarwanda',
      video: videoRef('Kinyarwanda.mp4'),
      answer: 'Kinyarwanda',
